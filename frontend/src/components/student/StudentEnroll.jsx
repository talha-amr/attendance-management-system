...
export default function AvailableCourseCard({
  ...
  const { refreshStudentData } = useContext(StudentContext);
  ...
  async function handleEnroll(event) {
    ...
    try {
       ...
       *
       * Refresh the shared student data so:
       * - My Courses updates
       * - Dashboard updates
       * - Timetable updates
       * - Available courses update
       */
      await refreshStudentData();

      // Keep the local enroll page UI updated if needed.
